...
public class FilterConfig {
	...
	public FilterRegistrationBean<GlobalFilter> globalFilter() {
		...
		registrationBean.setFilter(new GlobalFilter(tokenProvider));
	...
	public FilterRegistrationBean<AdminFilter> adminFilter() {
		...
		registrationBean.setFilter(new AdminFilter(tokenProvider));
	...
	public FilterRegistrationBean<HospitalFilter> hospitalFilter() {
		...
		registrationBean.setFilter(new HospitalFilter(tokenProvider));
