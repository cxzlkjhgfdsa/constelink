                    ...
                    <ul className={styles.ul}>
                        <li className={styles.dropdown}>
                            ...
                            <div className={styles["dropdown-content"]}>
                                ...
                                <span className={styles.a} onClick={()=>navigate("/notice")}>치료모금</span>
                                <span className={styles.a} onClick={()=>navigate("/notice")}>치료일지</span>
                                <span className={styles.a} onClick={()=>navigate("/notice")}>치료달성</span>
                                {
                                    authInfo.isAuthenticated ? <span> <span className={styles.a} onClick={()=>navigate("/mypage")}>마이페이지</span> <span className={styles.a} onClick={logoutHandler}>로그아웃</span></span> : <span className={styles.a} onClick={()=>navigate("/login")}>로그인</span>
                                }
